# -*- coding: utf-8 -*-
"""TimeSeriesForecastingResortHotel.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SoLwSQyVDBJlgIXsyivf7rVbIe9Oc0L-
"""
...
# Convert the 'Prophet_Forecast' column to integers
forecast_df['Prophet_Forecast'] = forecast_df['Prophet_Forecast'].astype(int)
...
print(test_output_viz.head())

# Plot the actual and forecasted data
test_output_viz.plot.line(figsize=(7, 4), fontsize=12)
plt.xlabel('Date', fontsize=12)
plt.ylabel('Bookings', fontsize=12)
plt.title('Actual vs Forecasted Bookings', fontsize=14)
plt.legend(['Actual Bookings', 'Prophet Forecast'])
plt.show()
